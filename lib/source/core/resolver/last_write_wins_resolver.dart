...
class LastWriteWinsResolver<T extends DatumEntity>
  ...
  FutureOr<DatumConflictResolution<T>> resolve({
    ...
    if (local == null && remote == null) {
      return DatumConflictResolution.abort('No data available for resolution.');
    }
    ...
    if (local.version != remote.version) {
      return local.version > remote.version
          ? DatumConflictResolution.useLocal(local)
          : DatumConflictResolution.useRemote(remote);
    }
